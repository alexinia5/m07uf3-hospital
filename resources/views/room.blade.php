...
<body class="p-0 m-0 bg-blue-50">
    <div class="container p-9 w-full h-screen flex flex-row gap-8">
        ...
        <main class="flex flex-col gap-2 w-full bg-white p-6 rounded-xl border border-neutral-200">
            <div class="searcher-btn inline-flex justify-between">
                <div class="relative  text-gray-500 focus-within:text-gray-900 mb-4">
                    ...
                    <input type="text" id="default-search" class="block w-80 h-11 pr-5 pl-12 py-2.5 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none" placeholder="Search for rooms">
                </div>
                <div>
            ...
            <div class="table-pagination w-full h-full flex flex-col items-start gap-6">
                <div class="cards inline-flex gap-20 w-full">
                    <div class="available w-96 bg-blue-100 border border-gray-300 p-3 rounded-xl">
                        <h2 class="text-sm">Available</h2>
                        <h1 class="num-av font-semibold text-lg">40</h1>
                        <p class="text-xs">Last update: 10 mins ago</p>
                    </div>
                    <div class="not-available w-96 bg-blue-100 border border-gray-300 p-3 rounded-xl">
                        <h2 class="text-sm">Not Available</h2>
                        <h1 class="num-not-av font-semibold text-lg">50</h1>
                        <p class="text-xs">Last update: 10 mins ago</p>
                    </div>
                </div>
                <div class="flex flex-col w-full h-full">
                    <div class=" overflow-x-auto">
                        <div class="overflow-hidden flex flex-col items-start gap-3 border border-x-gray-300 rounded-xl p-3">
                            <h1 class="text-lg font-semibold pl-4">Room Occupancy</h1>
                            <table class=" min-w-full rounded-xl">
                                <thead>
                                    <tr class="bg-gray-50 h-3">
                                        <th scope="col" class="p-2 text-left text-sm leading-6 font-semibold text-gray-900 capitalize rounded-t-xl"> Room ID</th>
                                        <th scope="col" class="p-2 text-left text-sm leading-6 font-semibold text-gray-900 capitalize">Availability</th>
                                        <th scope="col" class="p-2 text-left text-sm leading-6 font-semibold text-gray-900 capitalize">Admission Date</th>
                                        <th scope="col" class="p-2 text-left text-sm leading-6 font-semibold text-gray-900 capitalize">Floor Number</th>
                                        <th scope="col" class="p-2 text-left text-sm leading-6 font-semibold text-gray-900 capitalize rounded-t-xl"> Actions </th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-300 ">
                                    <tr class="bg-white transition-all duration-500 hover:bg-gray-50 h-3">
                                        <td class="p-2 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 "> RM239</td>
                                        <td class="p-2 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> No </td>
                                        <td class="p-2 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 20-02-2025</td>
                                        <td class="p-2 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> 2-4</td>
                                        <td class="p-2">
                                            <div class="flex items-center gap-1">
                                                    <a href="/rooms/edit" class="p-2  rounded-full  group transition-all duration-500  flex item-center">
                                                    ...
                                                    <a href="/rooms/delete" class="p-2 rounded-full  group transition-all duration-500  flex item-center">
