        ...
        <main class="flex flex-col gap-2 w-full bg-white p-6 rounded-xl border border-neutral-200">
            <div class="searcher-btn inline-flex justify-between">
                <div class="relative  text-gray-500 focus-within:text-gray-900 mb-4">
                    ...
                    <input type="text" id="default-search" class="block w-80 h-11 pr-5 pl-12 py-2.5 text-base font-normal shadow-xs text-gray-900 bg-transparent border border-gray-300 rounded-full placeholder-gray-400 focus:outline-none" placeholder="Search for emergencies">
                </div>
                <div>
                ...
                <div class="flex flex-col w-full h-full">
                    <div class=" overflow-x-auto">
                        <div class="overflow-hidden flex flex-col items-start gap-3 border border-x-gray-300 rounded-xl p-3">
                            <h1 class="text-lg font-semibold">Emergencies</h1>
                                    ...
                                    <tr class="bg-white transition-all duration-500 hover:bg-gray-50 h-3">
                                        ...
                                        <td class="p-2">
                                            <div class="flex items-center gap-1">
                                                    <a href="/emergencies/edit" class="p-2  rounded-full  group transition-all duration-500  flex item-center">
                                                    ...
                                                    <a href="/emergencies/delete" class="p-2 rounded-full  group transition-all duration-500  flex item-center">
