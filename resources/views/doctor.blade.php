        ...
        <div class="container p-9 w-full h-screen flex flex-row gap-8">
            ...
            <main class="flex flex-col gap-8 w-full">
                <div class="flex flex-row justify-around items-center h-16 bg-blue-100 rounded-xl p-4">
                    <h1 class="font-semibold text-blue-950">DOCTOR MANAGER</h1>
                    <div>
                        <a href="/doctors/create" class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-full">Create new doctor</a>
                    </div>
                </div>
                        ...
                        <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
                          <thead class="bg-blue-200">
                            <tr>
                              ...
                              <th scope="col" class="px-6 py-4 font-medium text-gray-900">Specialty</th>
                          ...
                          <tbody class="divide-y divide-gray-100 border-t border-gray-100">
                            <a href="/patients/read">
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4">83950285</td>
                                    <td class="px-6 py-4">Female</td>
                                    <td class="px-6 py-4">6928124044</td>
                                    <td class="px-6 py-4">Pediathric</td>
                                    <td class="px-6 py-4">Pediathric</td>
                                    <td class="px-6 py-4">
                                      <div class="flex justify-end gap-4">
                                        <a x-data="{ tooltip: 'Delete' }" href="/doctors/delete">
                                          <svg
                                        ...
                                        <a x-data="{ tooltip: 'Edite' }" href="/doctors/edit">
                                          <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            fill="none"
                                            viewBox="0 0 24 24"
